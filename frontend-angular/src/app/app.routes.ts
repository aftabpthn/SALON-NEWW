...
export const routes: Routes = [
  ...
  { path: 'payments/integrations', loadComponent: () => import('./pages/pos/payment-integrations/payments-integrations-page.component').then((m) => m.PaymentsIntegrationsPageComponent), canActivate: [authGuard] },
