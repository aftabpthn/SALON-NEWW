...
export const GRANTS: Record<string, string[]> = {
  ...
  marketingLead: ['read:dashboard', 'read:marketing', 'write:marketing', 'read:campaigns', 'write:campaigns', 'read:clients', 'read:leads', 'write:leads', 'read:coupons', 'write:coupons', 'read:whatsapp', 'write:whatsapp', 'read:reviews', 'read:reputation', 'write:reputation'],
  customMarketingLead: ['read:dashboard', 'read:marketing', 'write:marketing', 'read:campaigns', 'write:campaigns', 'read:clients', 'read:leads', 'write:leads', 'read:coupons', 'write:coupons', 'read:whatsapp', 'write:whatsapp', 'read:reviews', 'read:reputation', 'write:reputation'],
