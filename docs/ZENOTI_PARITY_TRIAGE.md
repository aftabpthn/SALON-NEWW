...
Generated 2026-08-03T15:17:51.653Z from `docs/evidence/zenoti-master-parity-register.json`.
...
AuraShine surface searched: 1508 route literals, 226 backend modules, 189 frontend routes, 585 database tables.

| Band | Rows | What it means |
|---|---:|---|
| High | 841 | A route or screen carries the capability's most distinctive term. Very likely already built — verify and map. |
| Medium | 1297 | Partial agreement across surfaces. Probably adjacent to something that exists. |
| Schema-only | 113 | Tables match but no route, module or screen does. The AI Scribe pattern: migrations ran, nothing reaches them. |
| Low | 74 | One weak signal. Treat as unknown. |
| None | 236 | Nothing in the codebase resembles it. Most likely a genuine gap. |
...
## High confidence — verify and map (841)

| Zenoti capability | Matched | Strongest AuraShine candidates |
|---|---|---|
| [HC-0001](https://help.zenoti.com/en/admin.html) Admin | admin | `page: frontend-angular:platform/saas-admin` |
...
| [HC-0003](https://help.zenoti.com/en/admin/add-new-centers-in-zenoti.html) Add new centers in Zenoti | add, centers | `route: /billing/invoices/:id/add-item`<br>`route: /public/kiosk/add-on-request`<br>`route: /balance-sheet/cost-centers` |
...
| [HC-0021](https://help.zenoti.com/en/admin/set-up-cash-drawers.html) Set up cash drawers | cash | `route: /pos/cash-drawer/:id/approval-link`<br>`route: /pos/cash-drawer/:id/approve`<br>`route: /pos/cash-drawer/:id/deposits` |
...
| [HC-0052](https://help.zenoti.com/en/ai-lead-management/sales-agent-leaderboard.html) Sales Agent Leaderboard | leaderboard, sales | `route: /pos/happy-hours/branch-leaderboard`<br>`page: frontend-angular:staff/leaderboard`<br>`page: staff-app:leaderboard` |
| [HC-0053](https://help.zenoti.com/en/ai-lead-management/security-role-permissions.html) Security role permissions | role, security | `route: /staff/auth-roles/:role_id`<br>`table: staff_role_assignments`<br>`route: /security/access-rules` |
...
| [HC-0100](https://help.zenoti.com/en/analytics/analytics-express/employee-insights-dashboard.html) Employee Insights Dashboard | dashboard, employee, insights | `route: /staff/shift-swaps/:id/employee-decision`<br>`route: /notifications/marketing-insights`<br>`route: /staff-os/coach/insights` |
...
| [HC-0104](https://help.zenoti.com/en/analytics/analytics-express/kpi-dashboard.html) KPI dashboard | dashboard, kpi | `route: /billing/clients/:id/kpi`<br>`route: /pos/clients/:id/kpi`<br>`route: /inventory/color-bowls/staff-shift-dashboard` |
| [HC-0106](https://help.zenoti.com/en/analytics/analytics-express/membership-metrics-dashboard.html) Membership Metrics dashboard | dashboard, membership, metrics | `route: /metrics`<br>`module: routes/metrics`<br>`route: /inventory/color-bowls/staff-shift-dashboard` |
...
| [HC-0116](https://help.zenoti.com/en/analytics/analytics-plus/analytics-subscription.html) Analytics subscription | analytics, subscription | `route: /staff/mobile/devices/:id/push-subscription`<br>`route: /booking-analytics/abandonments`<br>`route: /booking-analytics/abandonments/:id/recover` |
...
| [HC-0119](https://help.zenoti.com/en/analytics/business-snapshot/add-ons.html) Add-ons | add | `route: /billing/invoices/:id/add-item`<br>`route: /public/kiosk/add-on-request` |
...
| [HC-0127](https://help.zenoti.com/en/analytics/business-snapshot/products--retail-.html) Products (Retail) | products | `route: /customer/products/checkout`<br>`route: /marketplace/businesses/:id/products`<br>`route: /reports/products/movements` |
...
| [HC-0136](https://help.zenoti.com/en/appointments/daily-tasks.html) Daily tasks | daily, tasks | `route: /inventory/color-bowls/daily-variance`<br>`route: /invoice-notifications/daily-report/process`<br>`page: frontend-angular:billing/daily-closing` |
...
| [HC-0138](https://help.zenoti.com/en/appointments/daily-tasks/book-appointments/book-appointment-using-booking-wizard.html) Book appointment using Booking Wizard | appointment, book, booking, wizard | `route: /booking-wizard/state`<br>`route: /booking-wizard/state/:session_id`<br>`table: booking_wizard_state` |
...
| [HC-0164](https://help.zenoti.com/en/appointments/manage-guest-experience/manage-guests/add-guest-to-waitlist.html) Add guest to waitlist | add, guest, waitlist | `route: /billing/invoices/:id/add-item`<br>`route: /public/kiosk/add-on-request`<br>`route: /customer/bookings/:id/waitlist` |
| [HC-0165](https://help.zenoti.com/en/appointments/manage-guest-experience/manage-guests/add-notes.html) Add notes | add, notes | `route: /billing/invoices/:id/add-item`<br>`route: /public/kiosk/add-on-request`<br>`route: /appointments/:id/notes` |
...
| [HC-0178](https://help.zenoti.com/en/appointments/manage-guest-experience/manage-guests/view-service-forms-related-to-a-guest.html) View service forms related to a guest | forms, guest, service, view | `route: /staff-self/appointments/:appointment_id/guest-360/forms`<br>`route: /staff-self/appointments/:appointment_id/guest-360/forms/:submission_id/reviews`<br>`route: /clients/return-tracker/:view` |
| [HC-0182](https://help.zenoti.com/en/appointments/manage-guest-experience/manage-memberships.html) Manage memberships | memberships | `route: /customer/memberships`<br>`route: /customer/memberships/:id/auto-renew`<br>`route: /customer/memberships/:id/cancel` |

_781 more in the JSON report._

## Schema-only — finish it or drop the tables (113)

| Zenoti capability | Matched | Strongest AuraShine candidates |
|---|---|---|
| [HC-0038](https://help.zenoti.com/en/ai-lead-management/configure-automation-rules.html) Configure automation rules | automation, rules | `table: whatsapp_automation_rules`<br>`table: inventory_automation_actions`<br>`table: inventory_automation_policies` |
| [HC-0041](https://help.zenoti.com/en/ai-lead-management/configure-lead-sources.html) Configure lead sources | lead | `table: marketing_lead_activities` |
| [HC-0042](https://help.zenoti.com/en/ai-lead-management/configure-lead-stages.html) Configure lead stages | lead | `table: marketing_lead_activities` |
| [HC-0043](https://help.zenoti.com/en/ai-lead-management/configure-lead-types.html) Configure lead types | lead | `table: marketing_lead_activities` |
| [HC-0047](https://help.zenoti.com/en/ai-lead-management/lead-generation-forms.html) Lead generation forms | forms, lead | `table: marketing_lead_activities`<br>`route: /clients/:id/forms/:definition_id/kiosk-token`<br>`route: /clients/forms/definitions` |
| [HC-0049](https://help.zenoti.com/en/ai-lead-management/lead-report.html) Lead report | lead, report | `table: marketing_lead_activities`<br>`route: /ai/concierge/calls/report`<br>`route: /appointment-deposits/report` |
...
| [HC-0066](https://help.zenoti.com/en/analytics/analytics---amazon-s3/fact-and-dimension-tables--s3-/membership-user-redemptions-value-fact-table--s3-.html) Membership user redemptions value fact table (s3) | membership, redemptions, user | `table: pos_membership_redemptions`<br>`route: /clients/:id/store-credits/:credit_id/redemptions`<br>`route: /scim/v2/Users/:user_id` |
| [HC-0086](https://help.zenoti.com/en/analytics/analytics-dedicated-redshift/fact-and-dimension-tables--redshift-/membership-user-redemptions-value-fact-table--redshift-.html) Membership user redemptions value fact table (Redshift) | membership, redemptions, user | `table: pos_membership_redemptions`<br>`route: /clients/:id/store-credits/:credit_id/redemptions`<br>`route: /scim/v2/Users/:user_id` |
...
| [HC-0467](https://help.zenoti.com/en/configuration/forms-configurations/ai-scribe.html) AI Scribe | scribe | `table: staff_ai_scribe_events`<br>`table: staff_ai_scribe_sessions` |
| [HC-0468](https://help.zenoti.com/en/configuration/forms-configurations/ai-scribe/ai-scribe--faqs-and-troubleshooting.html) AI Scribe: FAQs and Troubleshooting | scribe | `table: staff_ai_scribe_events`<br>`table: staff_ai_scribe_sessions` |
| [HC-0470](https://help.zenoti.com/en/configuration/forms-configurations/ai-scribe/set-up-and-manage-ai-scribe.html) Set Up and Manage AI Scribe | scribe | `table: staff_ai_scribe_events`<br>`table: staff_ai_scribe_sessions` |
...
| [HC-0836](https://help.zenoti.com/en/configuration/pos-configurations/payments-and-invoices/allow-full-refund-on-an-invoice.html) Allow full refund on an invoice | invoice, refund | `table: pos_invoice_refund_lines`<br>`route: /billing/invoices/:id/refund`<br>`route: /booking-payments/:appointment_id/refund` |
...
| [HC-1201](https://help.zenoti.com/en/fitness/front-desk-actions/actions-on-point-of-sale--pos-.html) Actions on Point of Sale (POS) | actions, pos, sale | `table: pos_sale_lines`<br>`route: /pos/invoices/:id/actions`<br>`route: /pos/sales/:id/actions` |
...
| [HC-1392](https://help.zenoti.com/en/inventory/reports/near-expiry-report-for-batch-tracked-inventory.html) Near Expiry Report for Batch-Tracked Inventory | batch, inventory, report | `table: integration_opening_inventory_batch_applications`<br>`table: inventory_batch_movements`<br>`route: /appointments/batch` |
...
_53 more in the JSON report._

## No match — likely genuine gaps (236)
...
| [HC-0033](https://help.zenoti.com/en/admin/zenoti-is-not-loading-or-is-responding-slowly.html) Zenoti is not loading or is responding slowly |  | — |
...
| [HC-0254](https://help.zenoti.com/en/appointments/onboard-and-set-up/personalization/interface/display.html) Display |  | — |
| [HC-0257](https://help.zenoti.com/en/appointments/onboard-and-set-up/personalization/toolbar.html) Toolbar |  | — |
| [HC-0260](https://help.zenoti.com/en/appointments/onboard-and-set-up/set-up-a-pole-display.html) Set up a pole display |  | — |
...
| [HC-0338](https://help.zenoti.com/en/configuration/appointments-configurations/personalization/interface/display.html) Display |  | — |
...
_176 more in the JSON report._
