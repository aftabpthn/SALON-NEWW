...
- `GET /inventory/floor-control` returns one branch-scoped operational view of unopened stock, sealed container count and capacity, retail-available stock, open-floor balance, physical total, actual consumption, locations, custody history and recent closings. Sealed reserve is a subset of unopened stock; physical total is unopened stock plus open-container balance.
