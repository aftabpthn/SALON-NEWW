...
- Password-backed **JWT access tokens + refresh tokens**; refresh rotation on use.
...
- All input validated at the route boundary (`server/validators`); named SQL parameters make injection structurally impossible — string-built SQL is forbidden.
