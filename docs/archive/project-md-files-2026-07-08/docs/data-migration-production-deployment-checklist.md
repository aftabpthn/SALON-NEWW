...
- **done**: Production deployment checklist includes pre-deployment controls, staged execution flow, acceptance criteria, and post-live reconciliation actions.
- **in-progress**: None.
- **blocker**: None.

## Evidence Attachments

- **Ticket IDs**: `TKT-MIG-PROD-2026-07-01` (pre-deploy controls), `TKT-MIG-PROD-2026-07-02` (go-live checks)
- **Proof bundle hash**: `proof-bundles/data-migration-production-runbook-evidence-2026-07.json` → `sha256:f82454877da937ea0d1c13e10fdae13ff39773cf19ca8eeb84914aa7b1930e7e`
- **Attachment workflow**: Include proof bundle hash + production tickets before approving final deployment and rollback drill.
