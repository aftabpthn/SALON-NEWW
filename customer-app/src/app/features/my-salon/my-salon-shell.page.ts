...
@Component({
  ...
  styles: [`
    ...
    .shell-brand small { color: var(--muted, #667085); font-size: 0.67rem; font-weight: 900; text-transform: uppercase; letter-spacing: 0.08em; }
    .shell-actions { flex: 0 0 auto; gap: 6px; }
    .shell-actions button { gap: 5px; min-height: 34px; padding: 0 10px; border: 1px solid rgba(99, 102, 241, 0.16); border-radius: 999px; color: var(--primary, #6366F1); background: rgba(255, 255, 255, 0.78); font-size: 0.76rem; font-weight: 950; }
