  ...
  styles: [`
    .onboarding {
      ...
      background:
        ...
        radial-gradient(circle at 16% 18%, rgba(11, 70, 120, 0.2), transparent 32%),
        radial-gradient(circle at 84% 8%, rgba(7, 90, 156, 0.14), transparent 34%),
    ...
    .ambient-one {
      ...
      left: -70px;
      bottom: 12%;
      background: rgba(11, 70, 120, 0.18);
    }
    ...
    .hero::after {
      ...
      height: 220px;
      border-radius: 999px;
      background: radial-gradient(circle, rgba(11, 70, 120, 0.24), transparent 68%);
      pointer-events: none;
    }
    ...
    .brand-lockup img {
      ...
      height: 64px;
      border-radius: 16px;
      box-shadow: 0 16px 34px rgba(11, 70, 120, 0.16);
    }
