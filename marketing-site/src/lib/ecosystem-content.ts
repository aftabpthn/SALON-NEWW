...
export const ECOSYSTEM_CONTENT: Record<"en" | "hi", LocaleContent> = {
  ...
  hi: {
    ...
    route: {
      ...
      customer: { eyebrow: "Customer App", title: "एक salon visit, discovery से rebooking तक", body: "Salon चुनने, online prepayment के बिना booking करने, visit manage करने और useful history के साथ लौटने का current-scope journey।", disclosure: "Current capability story · payment salon पर", sections: [
        { title: "Discover", body: "Visit के अनुसार salon entries देखें।", items: ["Marketplace discovery", "Available salon entries"] },
        { title: "Profile पढ़ें", body: "चुनने से पहले salon समझें।", items: ["Salon information", "Services और available context"] },
        { title: "Service चुनें", body: "Visit का उद्देश्य तय करें।", items: ["Service selection", "Configured duration और price context"] },
        { title: "Professional चुनें", body: "Availability होने पर preferred professional चुनें।", items: ["Professional selection", "Booking में preference"] },
        { title: "Slot चुनें", body: "दिखाई गई availability से समय चुनें।", items: ["Date और time selection", "Branch-aware context"] },
        { title: "Book करें · salon पर pay करें", body: "Online prepayment claim के बिना confirm करें।", items: ["Pay-at-salon booking", "Upcoming visit record"], note: "Online prepayment को current scope नहीं बताया गया है।" },
        { title: "Plan manage करें", body: "Plan बदलने पर booking practical रखें।", items: ["Cancel", "Reschedule", "Upcoming visits review"] },
        { title: "आएँ और pay करें", body: "Salon service और checkout पूरा करता है।", items: ["Arrival और salon-side flow", "Payment salon पर"] },
        { title: "History, saved और rebook", body: "Personal context के साथ वापस आएँ।", items: ["Past visits और invoices", "Saved salons", "Rebook", "Read-only wallet और membership"], note: "Full offline, realtime push, complete iOS support या autonomous diagnosis claim नहीं। Consultation configured provider और fallback पर निर्भर है।" },
      ] },
      staff: { eyebrow: "Staff App", title: "एक workday, permission boundaries के साथ", body: "Arrival से end-day review तक detailed shift journey, बिना unrestricted owner controls दिखाए।", disclosure: "Current capability story · qualified Android attendance", sections: [
        { title: "Shift खोलें", body: "पहले client से पहले दिन देखें।", items: ["Staff login", "Daily command centre", "Roster और shift timing"] },
        { title: "Attendance दर्ज करें", body: "Owner policy से allowed method इस्तेमाल करें।", items: ["Enabled होने पर Android secure attendance", "Attendance और overtime records"], note: "Secure attendance Android-only और configuration dependent है।" },
        { title: "Schedule पढ़ें", body: "Assigned appointments और timing समझें।", items: ["Appointments", "Professional schedule", "Notifications"] },
        { title: "Context के साथ तैयारी", body: "Role को permitted client context ही देखें।", items: ["Permissioned visit notes", "Assigned service context"], note: "Full Client 360 controls Staff App के लिए claim नहीं हैं।" },
        { title: "Tasks पूरे करें", body: "Operational work shift के साथ रखें।", items: ["Task checklist", "Selected queued actions"], note: "Queued actions का मतलब full offline operation नहीं।" },
        { title: "Availability manage करें", body: "Owner policy bypass किए बिना changes request करें।", items: ["Leave requests", "Shift swaps", "Overtime context"] },
        { title: "Attribution देखें", body: "Permitted contribution और target context समझें।", items: ["Permission-gated service attribution", "Product attribution", "Targets और performance"] },
        { title: "Communicate करें", body: "Work communication दिन से जुड़ा रखें।", items: ["Notifications", "Chat", "Owner controls"] },
        { title: "दिन समाप्त करें", body: "Shift बंद करने से पहले personal work context review करें।", items: ["Attendance review", "Task status", "Permitted attribution visibility"], note: "Appointment execution controls को confirmed Staff App capability नहीं बताया गया है।" },
      ] },
