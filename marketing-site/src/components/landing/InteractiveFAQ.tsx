              ...
              return (
                ...
                >
                   <button
                    ...
                    aria-controls={`home-pricing-faq-panel-${idx}`}
                    id={`home-pricing-faq-trigger-${idx}`}
                  ...
                  >
                    ...
                    <ChevronDown className={`h-4 w-4 text-aura-text-muted transition-transform duration-200 ${isOpen ? "rotate-180 text-aura-burgundy" : ""}`} aria-hidden="true" />
                  </button>
                  {isOpen && (
                    <div id={`home-pricing-faq-panel-${idx}`} role="region" aria-labelledby={`home-pricing-faq-trigger-${idx}`} className="px-5 pb-5 text-xs leading-6 text-aura-text-secondary border-t border-aura-border/50 pt-3 animate-in fade-in">
                      {faq.answer}
                    </div>
                  )}
                </div>
