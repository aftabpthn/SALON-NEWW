    ...
    <>
      <Float speed={2} rotationIntensity={0.5} floatIntensity={1}>
        <mesh ref={mesh1} position={[-2.5, 1, -2]} scale={1.2}>
          ...
          <MeshDistortMaterial color="#681f37" speed={2} distort={0.3} roughness={0.2} metalness={0.8} />
        </mesh>
      </Float>
      ...
      <Float speed={1.5} rotationIntensity={0.4} floatIntensity={0.8}>
        <mesh ref={mesh2} position={[3, -1.2, -3]} scale={0.9}>
          ...
          <MeshDistortMaterial color="#c88d75" speed={1.5} distort={0.4} roughness={0.1} metalness={0.9} />
        </mesh>
      </Float>
    </>
  );
  ...
  return (
    <div className="absolute inset-0 pointer-events-none opacity-40 z-0 overflow-hidden">
      <Canvas>
        ...
        <pointLight position={[-10, -10, -5]} intensity={0.5} color="#e879a8" />
        <FloatingOrbs />
      </Canvas>
    </div>
  );
