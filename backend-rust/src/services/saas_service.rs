...
mod tests {
    use super::{
        add_sla_minutes, coupon_is_usable, decode_ticket_attachments, extract_email, usage_charge,
        BillingContext, TicketAttachmentInput, MANAGER_PERMISSION_CODES, STAFF_PERMISSION_CODES,
