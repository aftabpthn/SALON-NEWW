...
pub struct Settings {
    ...
    pub staff_app_minimum_version: String,
    pub staff_app_latest_version: String,
    pub staff_app_update_url: Option<String>,
    pub staff_app_force_update_enabled: bool,
...
impl Settings {
    pub fn load() -> Result<Self> {
        ...
        Ok(Settings {
            ...
            staff_app_minimum_version: var_or("STAFF_APP_MINIMUM_VERSION", "0.1.0"),
            staff_app_latest_version: var_or("STAFF_APP_LATEST_VERSION", "0.1.0"),
            staff_app_update_url: optional_value("STAFF_APP_UPDATE_URL"),
            staff_app_force_update_enabled: var_or_parse("STAFF_APP_FORCE_UPDATE_ENABLED", false)?,
