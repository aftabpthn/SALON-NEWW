  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "STAFF_APP_MINIMUM_VERSION", value = var.staff_app_minimum_version },
        { name = "STAFF_APP_LATEST_VERSION", value = var.staff_app_latest_version },
        { name = "STAFF_APP_UPDATE_URL", value = var.staff_app_update_url },
        { name = "STAFF_APP_FORCE_UPDATE_ENABLED", value = tostring(var.staff_app_force_update_enabled) },
